...
struct BatchedGemmTraits : public Base {
...
__global__ void batched_gemm_kernel(const Element* dA, const Element* dB,
                                    Element* dC) {
...
template <typename Element,                              //
          ...
          const int kTM, const int kTN, const int kTK>
void cute_batched_gemm(const Element* dA, const Element* dB, Element* dC) {
    using namespace benchmarks::cutlass_wrapper;

    using KeTraits = BatchedGemmTraits<Element, kWarpPerRow, kWarpPerCol, kM,
                                       kN, kK, kTM, kTN, kTK>;
    ...
    auto kernel =
        &batched_gemm_kernel<Element, kM, kN, kK, kTM, kTN, kTK, KeTraits>;
